...
python3 "$repo_dir/tools/test_wifi_product_network_hil_evidence.py"
python3 "$repo_dir/tools/test_wifi_name_listen_hil_evidence.py"
python3 "$repo_dir/tools/test_capture_1x_ui.py"
