...
"${CXX:-c++}" \
    ...
    "$repo_dir/firmware/leshy1/src/kernel/safety/RuntimeWatchdogJournal.cpp" \
...
python3 "$repo_dir/tools/check_wifi_own_identity_hil_acceptance.py"
...
python3 "$repo_dir/tools/check_cadence_full_357_acceptance.py"
python3 "$repo_dir/tools/check_protocol_task_tree_358_acceptance.py"
python3 "$repo_dir/tools/check_wifi_runtime_watchdog_acceptance.py"
...
python3 "$repo_dir/tools/test_airspace_guard_profiles_hil_runner.py"
