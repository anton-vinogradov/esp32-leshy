#!/usr/bin/env python3
"""Retain compact machine-checked evidence for passive Wi-Fi devices."""
...
EVIDENCE_IDS = ["E-BUILD-108", "E-AUTO-072", "E-HIL-132", "E-UX-027"]
...
def main() -> int:
    ...
    provenance = {
        "schema": "leshy.wifi_devices_hil.provenance.v1",
        "version": VERSION,
        "cid": CID,
    ...
    summary_value = {
        "schema": "leshy.wifi_devices.acceptance.v1",
        "status": "pass_wifi_devices_checkpoint",
        "board": "board-01",
        ...
        "verified": {
            ...
            "unique_devices_first": run["live_first"]["wifi_devices_unique"],
            "unique_devices_second": run["live_second"]["wifi_devices_unique"],
            "client_frames_accepted_second": run["live_second"][
                "wifi_device_clients_accepted"],
            "channel_hops_second": run["live_second"][
                "wifi_device_channel_hops"],
