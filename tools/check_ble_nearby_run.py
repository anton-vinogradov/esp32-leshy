...
def main() -> int:
    ...
    require(failures,
            list_render_first.get("list_refresh_period_us") == 2000000 and
            list_render_second.get("list_refresh_period_us") == 2000000 and
            ...
            "BLE list scan-window cadence/coalescing contract failed")
    ...
    require(failures,
            ...
            scope.get("list_refresh_cadence_hz_max") == 0.5 and
