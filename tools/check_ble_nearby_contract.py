...
def main() -> int:
    ...
    required_entry = (
        ...
        "kBleDeviceListUiRefreshPeriodUs = 2000000ULL",
        "current two-second passive scan-window cadence",
        "bleDeviceUiRefreshPending",
        "bleDeviceDetailRefreshesDeferred",
        "never fall through to a scene repaint",
        "bleDeviceListRenderCache.row(slot).sameIdentity(visual)",
        "name learned from later packets is retained",
        "bleDeviceListStaticChurnSuppressed",
        "bleDeviceDetailStaticChurnSuppressed",
        "radar is live while this card is open",
        "liveBleDeviceSignal()",
        ...
        "Acknowledge the catalog revision without painting",
        ...
        "kBleProductMinimumFreeHeapBeforeBegin = 72000U",
        ...
        "disjoint radio windows",
        "A BLE-only product may retain its passive",
