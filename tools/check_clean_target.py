...
def main() -> int:
    ...
    if not physical_sd_filesystem.is_file():
        ...
        for marker in (
            ...
            "BoardSdFilesystemMountStage::BusInitializing",
            "BoardSdFilesystemMountStage::VfsMounting",
            "BoardSdFilesystemMountStage::Mounted",
            "MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT",
            "busInitializeError",
            "heapFreeBeforeBus",
            "heapLargestBeforeBus",
            "heapFreeBeforeVfs",
            "heapLargestBeforeVfs",
