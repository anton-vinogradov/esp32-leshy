...
|---|---|---|---|---|---|---|
| R-001 | ESP32 module/PSRAM variants differ across v2 batches | M | H | constrain required profile to N16/no-PSRAM; mismatch is `fault`, never dynamic budget expansion | boards; HW-T01 on a second unit + assembly IDs | open |
...
| R-007 | No-PSRAM heap pressure, fragmentation, or unbounded queues fail long Survey runs | H | H | RB-03/04, bounded queues/pools, high-water/drop counters, no monotonic heap decline | kernel/services; size gate + 8 h endurance | open |
