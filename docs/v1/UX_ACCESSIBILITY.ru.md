...
Статус: **UX-06 принят по exact 0.56 source, physical-key и TFT evidence**.
...
| Вправо | P4, active low | `Right` | Open/context action, показанный в footer |
| Выбор | P6, active low | `Select` | активировать явно сфокусированное действие |
...
| Survey running list | переместить focus observation | Detail | Stop/commit | cancel без commit |
| Survey detail/result/error | — | — | — | list/Home без скрытого retry |
| Library list | переместить focus Session | Detail | Detail | Home |
| Library detail | — | — | Export | list |
| Export ready | — | — | — | detail |
| Diagnostics | — | — | — | Home |

Footer называет доступные controls в каждом контексте. Недоступный Home item не
