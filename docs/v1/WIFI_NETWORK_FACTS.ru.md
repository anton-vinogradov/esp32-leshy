...
имени из клиентского кадра в AP, источники/конфликты и hidden-name fixture ниже
...
отдельный тестовый бинарник. В dev.386 эта роль добавлена в штатную прошивку;
проверка остановлена на startup/USB-сбое оригинала ещё до запуска AP. Dev.387
добавляет этапы загрузки в журнал и feed после SD recovery, но пока не записана;
см. [сохранённый blocker](../../tests/hil/evidence/wifi-product-network-dev386-boot-blocker.json).
Последовательность
