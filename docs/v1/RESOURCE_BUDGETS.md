...
| Storage throughput/atomicity | bounded SessionStore matrices, guarded FAT/remount/reset evidence, passive Wi-Fi ingress, product workers/Stop, and 12-cycle continuity are measured; natural retries and injected timeout restart preserve prior generations; the real FIFO/batch path delivers 12,957 encoded B/s against required 2,184 B/s | measure LittleFS and physical power-cut separately; repeat 8 h on the S4 cross-radio workload | blocks full PR-005 verification, not S1/S2 |
