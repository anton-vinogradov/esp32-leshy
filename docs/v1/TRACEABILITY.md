...
| [UI automation contract](UI_AUTOMATION.md) | physical and diagnostic input share normalized Actions; actual TFT GRAM becomes reproducible PNG/state evidence without routine operator traversal | `UI-HIL-A1…A7`, `E-HIL-008/082`, `E-AUTO-022`; the S2 platform gate is accepted, and the same mechanism remains the Stage Demo/release evidence path |
