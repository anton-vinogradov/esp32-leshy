...
| Clean 1.x measurement target | independent pinned build implements BoardProfile, HardwareInventory→AppCatalog projection, unified display/input, shared UI components, on-device Self-Test, buzzer-safe boot output, storage/runtime contracts, guarded SD persistence, app-bound reset-separated boot retries, bounded Product Start raw-identity retry, and dual software/hardware boot-recovery watchdog tiers around the interactive exact-CID real passive Wi-Fi→FIFO→persistent SessionStore→cold-boot Library/export path | `E-BUILD-003…056`, `E-HIL-006…078`; implementation evidence for PR-002 and slices of PR-003…007/009/011/012/NFR-002/003/005…010 plus lower bounds for PR-001/014, NFR-001/010, RB-02…06; UX-03/04 are accepted and the 12-cycle checkpoint proves 51→63/144 observations/zero drift, while S2 closes on UX-05…07 and DEMO-S2 |
