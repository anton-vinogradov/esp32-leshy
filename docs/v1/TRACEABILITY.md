...
| [Automated pre-release HIL](PRE_RELEASE_HIL.md) | the combined foreground runner flashes an exact candidate, executes enrolled product Survey plus an isolated generic suite, restores exact-CID read-only state, and emits hash-indexed evidence; the bounded endurance runner checkpoints repeated exact-candidate cycles and enforces an 8 h/32-cycle floor; retained incidents and injected-timeout recovery are machine-checked | `E-AUTO-001…016`, `E-HIL-041…064`, ADR-005; GitHub-native combined HIL, natural reset-separated retries, deterministic no-OS watchdog recovery, and three-cycle regression are proven; real camera calibration, full endurance/destructive lanes, and stable publish remain open |
| [Storage atomicity HIL](STORAGE_HIL.md) | fixed dual heads publish only after sync; exact-fingerprint guards, guarded FAT lifecycle, real-source batching, six-boundary recovery, bounded Product Start identity retry, app-bound boot retry, lock-free recovery timeout, and interactive product commit/abort are physical | `E-STORAGE-001…005/019…023`, `E-SURVEY-003`, `E-LIBRARY-002/003`, `E-HIL-033…040/053/054/058…064`, `ST-HIL-A01…A10`; same-boot retry and blocking watchdog diagnostics are rejected; natural identity retry and injected timeout recover with zero writes; power-cut, full endurance, and LittleFS parity remain S5/S8 |
