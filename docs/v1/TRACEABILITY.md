...
| Clean 1.x measurement target | independent pinned build implements BoardProfile, HardwareInventory→AppCatalog projection, unified display/input, buzzer-safe boot output, storage/runtime contracts, guarded SD persistence, app-bound reset-separated boot retries, bounded Product Start raw-identity retry, and dual software/hardware boot-recovery watchdog tiers around the interactive exact-CID real passive Wi-Fi→FIFO→persistent SessionStore→cold-boot Library/export path | `E-BUILD-003…053`, `E-HIL-006…074`; implementation evidence for PR-002 and slices of PR-003…007/009/012/NFR-002/003/005…010 plus lower bounds for PR-001/014, NFR-001/010, RB-02…06; the hardware tier and its no-write read-only recovery are physical |
