...
| Golden Survey UI | simulated capability is explicit and RF-free; Home→List→Detail→Back preserves a running Session, explicit Stop precedes Home and lease release | `E-BUILD-011`, `E-HIL-014`, WF-02-A1/A2/A4/A5; board implementation evidence for PR-003/004 and NFR-002/006/010; persisted workflow remains open |
...
| Offline/persistent Library | a bounded controller admits only stopped/valid Sessions and exposes List/Detail with generation, integrity, simulated/persistent, and RF provenance; the current-boot recovered SD Session replaces the simulated fixture, acquires a Storage lease, and releases it on Back | `E-LIBRARY-001…002`, `E-BUILD-014/037`, `E-HIL-017/040`, WF-03-A1/A3; implementation evidence for PR-006 and NFR-002/003/008/010; boot-time media catalog/recovery remain open |
