...
| Clean 1.x measurement target | independent pinned build implements BoardProfile, HardwareInventory→AppCatalog projection, unified five-key display/input with non-color focus, a bounded observable PCF8574 boot probe, and compact incremental Left Back / Right-or-OK Enter / Up-Down Select navigation with non-blocking one-event/one-repaint physical dispatch, shared UI components and common-state cards, one EN/RU catalog with generated Roboto Condensed Medium 16/12 Cyrillic fonts and persistent Language selection, on-device Self-Test, buzzer-safe boot output, storage/runtime contracts, guarded SD persistence, app-bound reset-separated boot retries, bounded Product Start raw-identity retry, dual software/hardware boot-recovery watchdog tiers, and a persistent bounded Core-0 Product Survey worker with UI-owned terminal acknowledgement around the interactive exact-CID real passive Wi-Fi→FIFO→persistent SessionStore→cold-boot Library/export path | `E-BUILD-003…068`, `E-HIL-006…091`, `E-AUTO-022…031`, `E-GATE-002`; S2 is closed; exact 0.62 closes physical active-scan cancellation, 0.63 closes Roboto typography, 0.64 restores spatial navigation, 0.65 proves compact rendering, 0.66 exposes a post-render serial backpressure incident, and 0.67 removes it with 75 user-confirmed presses, high-water 1/64 and max queue latency 1.256 ms; missing-source real-TFT, physical power-cut, LittleFS parity, and final independent goldens remain |
...
| [Automated pre-release HIL](PRE_RELEASE_HIL.md) | combined runners bind exact candidates, product Survey, TFT evidence and final cleanup; product lanes prove async progress and active-scan cancellation, typography captures 18 EN/RU states, and navigation proves visible controls plus bounded non-blocking physical dispatch without manual traversal; endurance enforces the 8 h/32-cycle floor | `E-AUTO-001…020/024…031`, `E-HIL-041…075/084…091`, ADR-005; recovery and worker/cancel/typography/navigation regressions through exact 0.67 are proven without false release promotion; full endurance and stable publish remain later gates |
| [Storage atomicity HIL](STORAGE_HIL.md) | fixed dual heads publish only after sync; exact-fingerprint guards, guarded FAT lifecycle, real-source batching, six-boundary recovery, lower-clock bounded Product Start identity retry, app-bound boot retry, bounded recovery timeouts, persistent async source ownership, UI-owned terminal acknowledgement, and interactive product commit/abort are physical | `E-STORAGE-001…005/019…023`, `E-SURVEY-003`, `E-LIBRARY-002/003`, `E-HIL-033…040/053/054/058…075/084…086`, `ST-HIL-A01…A10`; E-HIL-085 proves normal Detail/commit/reboot recovery and E-HIL-086 proves active-scan cancel leaves generation 68/25 unchanged with zero writes/leases; physical power-cut, full cross-radio endurance, and LittleFS parity remain S3/S4/S5/S8 |
...
| Product Survey workflow | simulated capability remains explicit/RF-free when unenrolled; after exact-card boot admission AppCatalog selects real/persistent provenance and lease 15. Explicit Start enqueues intent before validating/retrying raw CID and filesystem access; a persistent bounded worker owns identity/mount/source/commit work while UI owns the pipeline and alone acknowledges terminal `Idle` after cleanup/commit. Live List/Detail/Back preserves and advances the source, Stop requests source shutdown before publishing/reopening exactly the next generation, and bounded boot recovery/reboot/export confirm it; failures preserve prior Library when cleanup evidence exists and fail closed when final state is unknown | `E-SURVEY-004…006`, `E-STORAGE-023`, `E-LIBRARY-003`, `E-AUTO-023…026`, `E-BUILD-011/040…042/046…053/061…063`, `E-HIL-014/046…048/053/054/057…075/083…086`, WF-02-A1…A5; exact 0.60 proves 67→68, live Detail progress and removal of the early-Idle race; exact 0.62 physically cancels an active scan without changing 68/25 or writing/leaking; physical power-cut, missing-source TFT, LittleFS, dense RF, and full S4 endurance remain open |
