...
| [UI automation contract](UI_AUTOMATION.md) | physical and diagnostic input share normalized Actions; actual TFT GRAM becomes reproducible PNG/state evidence without routine operator traversal; render mode/time makes responsiveness fail-closed | `UI-HIL-A1…A8`, `E-HIL-008/082/087…089`, `E-AUTO-022/027…029`, `E-UX-008…010`; exact 0.63 proves the 18-state EN/RU typography lane, 0.64 restores spatial navigation, and 0.65 proves compact changed-row rendering with nine TFT states/21 transitions |
| [Input and accessibility map](UX_ACCESSIBILITY.md) | five physical keys and diagnostic Back share normalized Actions; the 26 px footer maps Left/Up+Down/Right+OK spatially, focus has an outline/chevron, changed selections repaint only old/new rows, and status classes remain explicit text | `E-BUILD-058/059/065/066`, `E-HIL-052/080/081/088/089`, `E-AUTO-028/029`, `E-UX-006/007/009/010`; UX-06 and common-state UX-07 are accepted, with compact incremental navigation refined on exact 0.65 |
...
| [Automated pre-release HIL](PRE_RELEASE_HIL.md) | combined runners bind exact candidates, product Survey, TFT evidence and final cleanup; product lanes prove async progress and active-scan cancellation, typography captures 18 EN/RU states, and navigation proves visible controls plus bounded incremental render time without manual traversal; endurance enforces the 8 h/32-cycle floor | `E-AUTO-001…020/024…029`, `E-HIL-041…075/084…089`, ADR-005; recovery and worker/cancel/typography/navigation regressions through exact 0.65 are proven without false release promotion; full endurance and stable publish remain later gates |
