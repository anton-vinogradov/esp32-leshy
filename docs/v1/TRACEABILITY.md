...
| Clean 1.x measurement target | independent pinned build implements BoardProfile, HardwareInventory→AppCatalog projection, unified display/input, buzzer-safe boot output, storage/runtime contracts, guarded SD persistence, app-bound reset-separated boot retries, bounded Product Start raw-identity retry, and a lock-free boot-recovery watchdog around the interactive exact-CID real passive Wi-Fi→FIFO→persistent SessionStore→cold-boot Library/export path | `E-BUILD-003…052`, `E-HIL-006…071`; implementation evidence for PR-002 and slices of PR-003…007/009/012/NFR-002/003/005…010 plus lower bounds for PR-001/014, NFR-001/010, RB-02…06 |
...
| [Automated pre-release HIL](PRE_RELEASE_HIL.md) | the combined foreground runner flashes an exact candidate, executes enrolled product Survey plus an isolated generic suite, restores exact-CID read-only state, and emits hash-indexed evidence; the bounded endurance runner checkpoints repeated exact-candidate cycles and enforces an 8 h/32-cycle floor; malformed child metrics, retained incidents, and injected-timeout recovery are machine-checked | `E-AUTO-001…018`, `E-HIL-041…071`, ADR-005; GitHub-native combined HIL, natural reset-separated retries, deterministic no-OS watchdog recovery, retained release failures, and three-cycle regression are proven; real camera calibration, a passing full endurance/destructive lane, and stable publish remain open |
| [Storage atomicity HIL](STORAGE_HIL.md) | fixed dual heads publish only after sync; exact-fingerprint guards, guarded FAT lifecycle, real-source batching, six-boundary recovery, lower-clock bounded Product Start identity retry, app-bound boot retry, lock-free recovery timeout, and interactive product commit/abort are physical | `E-STORAGE-001…005/019…023`, `E-SURVEY-003`, `E-LIBRARY-002/003`, `E-HIL-033…040/053/054/058…071`, `ST-HIL-A01…A10`; same-boot retry, insufficient three-attempt boot recovery, and larger R1 polling are rejected by retained evidence; the eight-attempt reset-separated policy recovers with zero writes in short regression; power-cut, passing full endurance, and LittleFS parity remain S5/S8 |
...
| Passive Wi-Fi Survey ingress | passive-only plans reject active/directed operation; the explicit board adapter disables NVS/credentials, owns/cleans its event loop, and calls no connect/config/raw-TX API; under lease 15 the product path normalizes records into FIFO 64, commits one authorized Session, and passes the reboot-validated Session to Library/export | `E-SURVEY-001…003`, `E-BUILD-010/034/036/037/046…052`, `E-HIL-013/037/039/040/053/054/059/064/067/068/069/071`, WF-02-A1/A5; six 0.49 release cycles and the final 0.50 regression accept/forward 96/96 + 39/39 with zero drops; instrumented physical no-TX and a passing full endurance lane remain open |
| Product Survey workflow | simulated capability remains explicit/RF-free when unenrolled; after exact-card boot admission AppCatalog selects real/persistent provenance and lease 15. Explicit Start validates/retries only raw CID before filesystem access, then checks bounded cached space/root; passive scan drains FIFO 64, Stop publishes/reopens exactly the next generation, and bounded boot recovery/reboot/export confirm it; failures preserve prior Library and clean mount/backend | `E-SURVEY-004…006`, `E-STORAGE-023`, `E-LIBRARY-003`, `E-BUILD-011/040…042/046…052`, `E-HIL-014/046…048/053/054/057…071`, WF-02-A1/A2/A4/A5; lower-clock raw identity, retained boot failure, eight-attempt recovery, and final three-cycle continuity are proven for one card; power-cut/dense RF/passing full endurance remain open |
