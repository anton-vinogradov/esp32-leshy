...
| Product Survey workflow | simulated capability is explicit and RF-free; Setup→Running→List/Detail→Stop & Commit idempotently publishes/reopens one RAM generation, atomically replaces Library, and exports that same Session; failures preserve the prior Library | `E-SURVEY-004`, `E-LIBRARY-003`, `E-BUILD-011/040`, `E-HIL-014/046`, WF-02-A1/A2/A4/A5; board implementation evidence for PR-003…007 and NFR-002/003/006…010; real source/FIFO/persistent adapter and boot mount policy remain open |
