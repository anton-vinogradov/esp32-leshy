...
| [UI automation contract](UI_AUTOMATION.md) | physical and diagnostic input share normalized Actions; actual TFT GRAM becomes reproducible PNG/state evidence without routine operator traversal | `UI-HIL-A1…A8`, `E-HIL-008/082/087/088`, `E-AUTO-022/027/028`, `E-UX-008/009`; exact 0.63 proves the 18-state EN/RU typography lane and exact 0.64 proves spatial navigation with nine TFT states and 15 transitions |
| [Input and accessibility map](UX_ACCESSIBILITY.md) | five physical keys and diagnostic Back share normalized Actions; the 40 px footer maps Left/Up+Down/Right+OK spatially, focus has an outline/chevron, and status classes remain explicit text | `E-BUILD-058/059/065`, `E-HIL-052/080/081/088`, `E-AUTO-028`, `E-UX-006/007/009`; UX-06 and common-state UX-07 are accepted, with navigation refined on exact 0.64 |
...
| [Automated pre-release HIL](PRE_RELEASE_HIL.md) | combined runners bind exact candidates, product Survey, TFT evidence and final cleanup; product lanes prove async progress and active-scan cancellation, typography captures 18 EN/RU states, and spatial navigation proves the visible key model without manual traversal; endurance enforces the 8 h/32-cycle floor | `E-AUTO-001…020/024…028`, `E-HIL-041…075/084…088`, ADR-005; recovery and worker/cancel/typography/navigation regressions through exact 0.64 are proven without false release promotion; full endurance and stable publish remain later gates |
