...
## Уже установлено — 14 сентября, dev.384
...
Пока в проекте: четыре входа корня Wi-Fi, контекстный переход в Lab, пауза радара,
расширенное скрытое имя/источник/конфликты и оставшиеся доработки сквозных мастеров.
