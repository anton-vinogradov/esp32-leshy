...
## Уже установлено — 14 сентября, dev.388
...
Пока в проекте: контекстный переход в Lab, пауза радара, расширенное скрытое
имя/источник/конфликты и оставшиеся доработки сквозных мастеров.
