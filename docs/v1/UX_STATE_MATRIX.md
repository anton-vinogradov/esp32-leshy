...
| UX-S23/S24 Device/Diagnostics | module is always declared/detected/available/conflicted/fault/unknown; no fake percentage | cancellable read-only probe/report progress | live metrics issue no TX | unknown/partial evidence is labelled | probe fault is isolated from neighboring modules | risky self-test is absent | export report has build/profile/checksum | Back ends probe and releases leases |
