...
| CAP-061 | Owned Evidence Verification checks owned evidence with preview, budget, pause/stop/checkpoint and provenance: Leshy captures and validates Wi-Fi PMKID/EAPOL, exports canonical `hc22000`, and the computer companion performs the common/weak-password and vendor-default corpus comparison; NFC/Sub-GHz/fixed-code checks may be local or companion-assisted. Identity-linked leaked corpora are never bundled, plaintext matches never return to or persist on Leshy, and the retained report stores only weakness class, corpus provenance/rank and evidence references | P1 | J-03, J-06, PR-033, NFR-011 | S7 |
