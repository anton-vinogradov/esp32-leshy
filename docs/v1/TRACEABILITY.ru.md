...
| [HIL атомарности storage](STORAGE_HIL.ru.md) | fixed dual heads публикуют только после sync; exact-fingerprint guards, guarded FAT lifecycle, real-source batching, six-boundary recovery, bounded Product Start/boot retries и watchdogs, persistent async source ownership, UI-owned terminal acknowledgement, interactive commit/abort, localized missing-source cleanup и isolated normal/remount LittleFS parity проверены physical | `E-STORAGE-001…005/019…024`, `E-SURVEY-003/007`, `E-LIBRARY-002/003`, `E-HIL-033…040/053/054/058…075/084…086/092/093`, `ST-HIL-A01…A11`; E-HIL-093 подтверждает 32/32 LittleFS commits, 18 586 B/s, RO remount 32/64, exact restore OTA1/table и unchanged product 68/25; physical power-cut, full cross-radio endurance и LittleFS reset-boundary matrix остаются S3/S4/S5/S8 |
...
| Normal/remount parity disposable LittleFS | explicit adapter выбирает только inactive OTA1 `app1` по `0x410000`/4 MiB после доказательства separation running/boot и disjoint product `spiffs`; host two-read SHA-256 backup разрешает format, common SessionStore делает 32 commits, RO remount восстанавливает 32/64, затем host восстанавливает и хеширует OTA1 плюс partition table до product cold boot | `E-STORAGE-024`, `E-BUILD-070`, `E-AUTO-033`, `E-HIL-093`, normal/throughput slice ST-HIL-A07; 96+96 barriers, 18 586 B/s против 2 184 B/s, zero product/SD/NVS/radio touch, exact restore и unchanged product generation 68/25; six-boundary LittleFS reset и physical power-cut открыты |
