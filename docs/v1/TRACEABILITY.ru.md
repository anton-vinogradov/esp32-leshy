...
| Golden Survey UI | simulated capability явная и RF-free; Home→List→Detail→Back сохраняет running Session, explicit Stop предшествует Home и release lease | `E-BUILD-011`, `E-HIL-014`, WF-02-A1/A2/A4/A5; board implementation evidence для PR-003/004 и NFR-002/006/010; persisted workflow остаётся open |
...
| Offline/persistent Library | bounded controller принимает только stopped/valid Sessions и показывает List/Detail с generation, integrity, simulated/persistent и RF provenance; current-boot recovered SD Session заменяет simulated fixture, получает Storage lease, а Back освобождает его | `E-LIBRARY-001…002`, `E-BUILD-014/037`, `E-HIL-017/040`, WF-03-A1/A3; implementation evidence для PR-006 и NFR-002/003/008/010; boot-time media catalog/recovery открыты |
