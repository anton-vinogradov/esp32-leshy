...
| [UI automation contract](UI_AUTOMATION.ru.md) | physical и diagnostic input используют normalized Actions; actual TFT GRAM становится воспроизводимым PNG/state evidence без рутинного участия оператора | `UI-HIL-A1…A8`, `E-HIL-008/082/087/088`, `E-AUTO-022/027/028`, `E-UX-008/009`; exact 0.63 доказывает typography lane 18 states EN/RU, exact 0.64 — пространственную навигацию девятью TFT states и 15 transitions |
| [Карта input и accessibility](UX_ACCESSIBILITY.ru.md) | пять физических кнопок и diagnostic Back используют normalized Actions; footer 40 px пространственно отображает Left/Up+Down/Right+OK, focus имеет outline/chevron, status остаётся явным текстом | `E-BUILD-058/059/065`, `E-HIL-052/080/081/088`, `E-AUTO-028`, `E-UX-006/007/009`; UX-06 и common-state UX-07 приняты, navigation уточнена exact 0.64 |
...
| [Автоматический предрелизный HIL](PRE_RELEASE_HIL.ru.md) | combined runners связывают exact candidates, product Survey, TFT evidence и final cleanup; product lanes доказывают async progress и active-scan cancellation, typography снимает 18 EN/RU states, а пространственная навигация проверяет видимую key model без ручного прохода; endurance требует floor 8 h/32 cycles | `E-AUTO-001…020/024…028`, `E-HIL-041…075/084…088`, ADR-005; recovery и worker/cancel/typography/navigation regressions до exact 0.64 доказаны без ложного release promotion; full endurance и stable publish остаются later gates |
