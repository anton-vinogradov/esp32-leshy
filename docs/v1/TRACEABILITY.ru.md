...
| Product Survey workflow | simulated capability остаётся explicit/RF-free без enrollment; после exact-card boot admission AppCatalog выбирает real/persistent provenance и lease 15. Explicit Start validates/retries только raw CID до filesystem access, затем проверяет bounded cached space/root; passive scan drain FIFO 64, Stop publishes/reopens ровно следующую generation, bounded boot recovery/reboot/export подтверждают её; failures сохраняют prior Library при наличии cleanup evidence и fail closed при unknown final state | `E-SURVEY-004…006`, `E-STORAGE-023`, `E-LIBRARY-003`, `E-BUILD-011/040…042/046…053`, `E-HIL-014/046…048/053/054/057…075`, WF-02-A1/A2/A4/A5; hardware timeout recovery и continuity 48→63 подтверждены; shortened 12-cycle checkpoint принят как engineering evidence, power-cut/dense RF/full S4 endurance открыты |
