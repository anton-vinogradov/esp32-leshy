...
| [UI automation contract](UI_AUTOMATION.ru.md) | physical и diagnostic input используют normalized Actions; actual TFT GRAM становится воспроизводимым PNG/state evidence без рутинного участия оператора; render mode/time делает responsiveness fail-closed | `UI-HIL-A1…A8`, `E-HIL-008/082/087…089`, `E-AUTO-022/027…029`, `E-UX-008…010`; exact 0.63 доказывает typography lane 18 states EN/RU, 0.64 возвращает пространственную навигацию, 0.65 доказывает compact changed-row rendering девятью TFT states/21 transition |
| [Карта input и accessibility](UX_ACCESSIBILITY.ru.md) | пять физических кнопок и diagnostic Back используют normalized Actions; footer 26 px пространственно отображает Left/Up+Down/Right+OK, focus имеет outline/chevron, changed selection перерисовывает только old/new rows, status остаётся явным текстом | `E-BUILD-058/059/065/066`, `E-HIL-052/080/081/088/089`, `E-AUTO-028/029`, `E-UX-006/007/009/010`; UX-06 и common-state UX-07 приняты, compact incremental navigation уточнена exact 0.65 |
...
| [Автоматический предрелизный HIL](PRE_RELEASE_HIL.ru.md) | combined runners связывают exact candidates, product Survey, TFT evidence и final cleanup; product lanes доказывают async progress и active-scan cancellation, typography снимает 18 EN/RU states, navigation проверяет видимые controls и bounded incremental render time без ручного прохода; endurance требует floor 8 h/32 cycles | `E-AUTO-001…020/024…029`, `E-HIL-041…075/084…089`, ADR-005; recovery и worker/cancel/typography/navigation regressions до exact 0.65 доказаны без ложного release promotion; full endurance и stable publish остаются later gates |
