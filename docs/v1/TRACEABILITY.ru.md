...
| Product Survey workflow | simulated capability явная и RF-free; Setup→Running→List/Detail→Stop & Commit идемпотентно публикует/reopens одну RAM generation, атомарно заменяет Library и экспортирует ту же Session; failures сохраняют прежнюю Library | `E-SURVEY-004`, `E-LIBRARY-003`, `E-BUILD-011/040`, `E-HIL-014/046`, WF-02-A1/A2/A4/A5; board implementation evidence для PR-003…007 и NFR-002/003/006…010; real source/FIFO/persistent adapter и boot mount policy остаются open |
