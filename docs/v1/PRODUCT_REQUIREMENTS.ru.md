...
| PR-004 | Общие List/Detail/Radar доступны для поддерживаемых Observation/Target Живой просмотр сетей/устройств/графиков не требует SD; сохранение требует отдельного разрешения хранилища (ADR-008). | Back, фильтры и единицы измерения ведут себя одинаково между радио | P0 |
