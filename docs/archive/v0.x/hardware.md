...
> **Archived 0.x documentation.** Pin assumptions here describe the proof-of-concept
> firmware. The authoritative 1.x board model lives in [the 1.x docs](../../README.md).
