...
- **Проверенный checkpoint:** Dev.388: 8 снимков TFT, свежие наблюдения той же AP на 12/14/15/17 отсчётах, Stop по таймеру замечен хостом через 60,395 с; таймер изменил 29 динамических и ноль статических пикселей. Оба DIV завершили Home/none/lease 0, safety armed, ноль drops/операций SD. Меню dev.385 и карточки/график 13 каналов dev.384 сохраняют отдельные baselines; это не полная matrix и не оптическая гарантия отсутствия мерцания.
- **Следующий gate:** Прогресс **24/62**, Wi-Fi **17/21 готово, 4/21 осталось**. Далее: подключить ограниченный декодер имени к приёму на выбранном канале и источникам/конфликтам карточки, отдельно проверить association клиента. Переподключение восстановило оригинал; загрузка dev.387/388 и AP-дельта dev.388 прошли. Сбой загрузки dev.386 сохранён; первопричина окончательно не доказана. Wi-Fi ноутбука не менялся.
