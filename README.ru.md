...
| S5.5 | Полнота runtime: exact 0.133 принимает heartbeat/deadline slice Wi-Fi worker Product Survey; BLE/preparation, остальные workers, low-voltage safe-write, sleep/resume и применимые явные assembly profiles GPS/PN532 остаются | ⬜ дальше |
