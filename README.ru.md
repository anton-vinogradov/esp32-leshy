...
| S5.5 | Полнота runtime: exact 0.134 принимает калиброванные heartbeat/deadline slices Wi-Fi+BLE worker Product Survey; preparation/admission, остальные workers, low-voltage safe-write, sleep/resume и применимые явные assembly profiles GPS/PN532 остаются | ⬜ дальше |
