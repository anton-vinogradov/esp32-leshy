...
- **Проверенный checkpoint:** Дельта меню Wi-Fi dev.385: 10 состояний переходов, 5 снимков TFT, вход клавишей/тачем, границы выбора, возврат к прежней строке, финальный Home/none/lease 0 и ноль drops/операций SD. Dev.384 остаётся exact-image baseline восьми страниц карточки и графика 13 каналов.
- **Следующий gate:** Progress **24/62**, Wi-Fi **17/21 готово, 4/21 осталось**. Оба собственных DIV подключены и простаивают на штатном Лешем (оригинал dev.378, board-03 dev.385). Сначала реализовать ограниченную пользовательскую роль тестовой сети в обычной прошивке, затем проверять скрытое имя/источник через продуктовые пути обеих плат; без отдельного fixture-бинарника. Отменённая fixture-сборка была собрана, но не прошивалась и не запускалась. Интеграция дерева задач/мастеров и допущенная Wi-Fi Lab остаются открыты. Wi-Fi ноутбука не используется как fixture. Тёплый BLE и очередная полная physical matrix остаются отдельными незакрытыми gates.
