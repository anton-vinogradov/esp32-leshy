...
Собрать, залить, запустить и выпустить — см. **[docs/DEVELOPING.ru.md](docs/DEVELOPING.ru.md)**. Прошить чистую плату из браузера: **[веб-установщик](https://anton-vinogradov.github.io/esp32-leshy/)**.
