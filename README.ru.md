...
- **Следующий gate:** Прогресс **24/62**, Wi-Fi **17/21 готово, 4/21 осталось**. Декодер выбранного канала и объединение с карточкой установлены; далее доказать имя из association реального клиента, пока AP скрыта. При текущих ролях двух DIV (AP/приёмник) нужен третий свой клиент. Потери USB-диагностики остаются открыты: исправлены чтение фрагментов и вводящие в заблуждение повторы timed-capture, но позднейший pass не доказывает причину прежнего тайм-аута. Wi-Fi ноутбука не менялся.
