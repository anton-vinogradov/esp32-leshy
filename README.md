...
| S5.5 | Runtime completeness: exact 0.136 accepts Product Survey preparation/admission, calibrated Wi-Fi+BLE workers and Wi-Fi Capture Store worker heartbeat/deadline slices; Sub-GHz/IR store workers, low-voltage safe-write, sleep/resume and applicable explicit GPS/PN532 assembly profiles remain | ⬜ later |
