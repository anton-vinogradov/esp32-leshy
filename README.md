...
| FF-4 | Finish `FUNC-38` local USB/Web browse, search, compare and export without making network access a device dependency; dev.360 completes host/build search/export, dedicated-client HTTP parity remains | 🟡 active |
