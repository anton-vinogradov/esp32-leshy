...
- **Verified checkpoint:** exact `1.0.0-dev.242` at source `8483f6e1be24724ebf00172323cee253b9b64b39` physically completes the full receive-only CAP-048 Airspace Guard matrix in `E-BUILD-173`/`E-AUTO-147`/`E-HIL-190`/`RB-M184`. One exact candidate (`firmware 2b4a9fbdfa294bc3e632a6f707b37b3dcbc9151888320dc0ceda607794f21f5e`, embedded app identity `02b27bc09cbb507a621e6a69ae42b41090e50e371ec3c4f4d85c3de1e2116d5d`) runs a complete baseline lifecycle with 54 retained BLE records and zero drops, then a deterministic capacity-loss lifecycle with 1 retained and 904 dropped of 905 observed records. The latter remains visibly `inconclusive`/incomplete, publication fails closed, cleanup returns Home/none/lease 0, and the warm heap tuple stays invariant at 60,540/72,324/25,588 B. Machine-checked TFT proof changes 397 Wi-Fi and 215 BLE content pixels with zero static-chrome changes.
