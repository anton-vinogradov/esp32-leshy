...
| FF-4 | Finish `FUNC-38` local USB/Web browse, search, compare and export without making network access a device dependency; dev.361 completes bilingual task-first host/build presentation and local preview, dedicated-client HTTP parity remains | 🟡 active |
